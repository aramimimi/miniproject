...
<ul class="nav justify-content-center bg-gradient bg-opacity-50">
  ...
  <li class="nav-item">
    <a class="nav-link bi bi-stopwatch fs-6 text-center " href="/omakaseProject/res/resForm"> 실시 예약</a>
  </li>
  <li class="nav-item">
    <a class="nav-link bi bi-calendar-check fs-6 text-center" href="/omakaseProject/res/resForm"> 예약 안내</a>
  </li>
  <li class="nav-item">
